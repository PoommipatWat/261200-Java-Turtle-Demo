...
//        System.out.println(Arrays.toString(fontNames));
     ...
     */
    public static int isRunning(Turtle bob, float length, int depth)
    {
        if (depth == 0) return 0;
        else if (depth >= 5) bob.penColor("brown");
        else bob.penColor("green");
        bob.forward(length);
        bob.right(20);
        bob.width(depth);

        isRunning(bob, (float) (length), depth-1);
        bob.left(40);
    ...
    public static void heart(Turtle bot, int j, int k, int m){
        float Y = 0;
        float X = 0;
        double X_old = 0;
        double Y_old = 0;
        ...
        if(j == 0) bot.left(45);
        else if (j == 1) bot.left(90);
        else if (j == 2) bot.left(135);
        else if (j == 3) bot.left(180);
        else if (j == 4) bot.left(225);
        else if (j == 5) bot.left(270);
        else if (j == 6) bot.left(315);
        else if (j == 7) bot.left(360);
    ...
    public static void main(String[] a)
    {
        ...
        Turtle bob33 = new Turtle();
        bob33.penColor("green");
        bob33.width(50);
        bob33.speed(sp);
        bob33.right(90);
        bob33.forward(1000);
        ...
        Turtle bob4 = new Turtle();
        bob4.penColor("red");
        bob4.width(2);
        bob4.speed(sp);
        heart(bob4,1,-1,0);

        Turtle bob5 = new Turtle();
        bob5.penColor("red");
        bob5.width(2);
        bob5.speed(sp);
        heart(bob5,2,1,0);

        Turtle bob6 = new Turtle();
        bob6.penColor("red");
        bob6.width(2);
        bob6.speed(sp);
        heart(bob6,2,-1,0);

        Turtle bob7 = new Turtle();
        bob7.penColor("red");
        bob7.width(2);
        bob7.speed(sp);
        heart(bob7,3,1,0);
        
        Turtle bob8 = new Turtle();
        bob8.penColor("red");
        bob8.width(2);
        bob8.speed(sp);
        heart(bob8,3,-1,0);

        Turtle bob9 = new Turtle();
        bob9.penColor("red");
        bob9.width(2);
        bob9.speed(sp);
        heart(bob9,4,1,0);
        
        Turtle bob10 = new Turtle();
        bob10.penColor("red");
        bob10.width(2);
        bob10.speed(sp);
        heart(bob10,4,-1,0);
        
        Turtle bob11 = new Turtle();
        bob11.penColor("red");
        bob11.width(2);
        bob11.speed(sp);
        heart(bob11,5,1,0);

        Turtle bob12 = new Turtle();
        bob12.penColor("red");
        bob12.width(2);
        bob12.speed(sp);
        heart(bob12,5,-1,0);

        Turtle bob13 = new Turtle();
        bob13.penColor("red");
        bob13.width(2);
        bob13.speed(sp);
        heart(bob13,6,1,0);

        Turtle bob14 = new Turtle();
        bob14.penColor("red");
        bob14.width(2);
        bob14.speed(sp);
        heart(bob14,6,-1,0);

        Turtle bob15 = new Turtle();
        bob15.penColor("red");
        bob15.width(2);
        bob15.speed(sp);
        heart(bob15,7,1,0);

        Turtle bob16 = new Turtle();
        bob16.penColor("red");
        bob16.width(2);
        bob16.speed(sp);
        heart(bob16,7,-1,0);

        Turtle bob17 = new Turtle();
        bob17.penColor("red");
        bob17.width(2);
        bob17.speed(sp);
        heart(bob17,0,1,2);

        Turtle bob18 = new Turtle();
        bob18.penColor("red");
        bob18.width(2);
        bob18.speed(sp);
        heart(bob18,0,-1,2);

        Turtle bob19 = new Turtle();
        bob19.penColor("red");
        bob19.width(2);
        bob19.speed(sp);
        heart(bob19,1,1,2);

        Turtle bob20 = new Turtle();
        bob20.penColor("red");
        bob20.width(2);
        bob20.speed(sp);
        heart(bob20,1,-1,2);

        Turtle bob21 = new Turtle();
        bob21.penColor("red");
        bob21.width(2);
        bob21.speed(sp);
        heart(bob21,2,1,2);

        Turtle bob22 = new Turtle();
        bob22.penColor("red");
        bob22.width(2);
        bob22.speed(sp);
        heart(bob22,2,-1,2);

        Turtle bob23 = new Turtle();
        bob23.penColor("red");
        bob23.width(2);
        bob23.speed(sp);
        heart(bob23,3,1,2);

        Turtle bob24 = new Turtle();
        bob24.penColor("red");
        bob24.width(2);
        bob24.speed(sp);
        heart(bob24,3,-1,2);

        Turtle bob25 = new Turtle();
        bob25.penColor("red");
        bob25.width(2);
        bob25.speed(sp);
        heart(bob25,4,1,2);

        Turtle bob26 = new Turtle();
        bob26.penColor("red");
        bob26.width(2);
        bob26.speed(sp);
        heart(bob26,4,-1,2);

        Turtle bob27 = new Turtle();
        bob27.penColor("red");
        bob27.width(2);
        bob27.speed(sp);
        heart(bob27,5,1,2);

        Turtle bob28 = new Turtle();
        bob28.penColor("red");
        bob28.width(2);
        bob28.speed(sp);
        heart(bob28,5,-1,2);

        Turtle bob29 = new Turtle();
        bob29.penColor("red");
        bob29.width(2);
        bob29.speed(sp);
        heart(bob29,6,1,2);

        Turtle bob30 = new Turtle();
        bob30.penColor("red");
        bob30.width(2);
        bob30.speed(sp);
        heart(bob30,6,-1,2);

        Turtle bob31 = new Turtle();
        bob31.penColor("red");
        bob31.width(2);
        bob31.speed(sp);
        heart(bob31,7,1,2);

        Turtle bob32 = new Turtle();
        bob32.penColor("red");
        bob32.width(2);
        bob32.speed(sp);
        heart(bob32,7,-1,2);
